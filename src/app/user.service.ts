...
export class UserService implements OnInit {
    ...
    addUser(user: string, password: string, level: string) {
        ...
        this.http.post<{ message: string }>(Constants.url+'usuarios/signup', this.user).subscribe((response) => {
    ...
    loginUser(user: string, password: string) {
        this.user = new User(user, password);
        this.http.post<{ token: string, expiresIn: number, user:string, level:string }>(Constants.url+'usuarios/login', this.user).subscribe((userBack) => {
